...
namespace KDDongHo.Controllers
{
    public class AdminClientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,HOTEN,NGAYSINH,DIACHI,SDT,EMAIL,PASS")] KHACH_HANG kHACH_HANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,HOTEN,NGAYSINH,DIACHI,SDT,EMAIL,PASS")] KHACH_HANG kHACH_HANG)
        {
            if (ModelState.IsValid)
            {
